    ...
    if (loading) {
        return (
            <View className="flex-1 justify-center items-center bg-gray-50">
                ...
                <Text className="mt-4 text-base text-gray-600">Loading brand profile...</Text>
            </View>
        );
    }
        ...
        <ScrollView className="flex-1 bg-gray-50">
            ...
            <View className="bg-white px-5 pb-6">
                <View className="items-center -mt-16">
                    ...
                    <View className="flex-row items-center mt-4">
                        ...
                        {brand.is_verified && (
                            <Ionicons name="checkmark-circle" size={24} color="#3b82f6" className="ml-2" />
                        )}
                    </View>

                    <Text className="text-base text-gray-600 mt-1">@{brand.username}</Text>

                    {brand.industry && (
                        <View className="bg-blue-100 px-4 py-1 rounded-full mt-2">
                            <Text className="text-sm text-blue-800 font-medium">{brand.industry}</Text>
                        </View>
                    )}
            ...
            <View className="p-5">
                ...
                <View className="bg-white rounded-2xl p-5 mb-4 shadow-sm">
                    <Text className="text-lg font-bold text-gray-900 mb-4">Brand Stats</Text>
                        ...
                        <View className="w-[48%] mb-4">
                            <View className="flex-row items-center mb-2">
                                ...
                                <View>
                                    ...
                                    <Text className="text-xs text-gray-600">Total Campaigns</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View className="w-[48%]">
                            <View className="flex-row items-center mb-2">
                                ...
                                <View>
                                    ...
                                    <Text className="text-xs text-gray-600">Creators</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View className="w-[48%]">
                            <View className="flex-row items-center mb-2">
                                ...
                                <View>
                                    ...
                                    <Text className="text-xs text-gray-600">Total Spent</Text>
                                </View>
                            </View>
                        </View>
                    </View>
